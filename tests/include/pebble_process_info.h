...
// sdk.major:5 .minor:1 -- Added additional API functions (MenuLayer callbacks)
// sdk.major:5 .minor:2 -- Changed app heap double free behaviour.
// sdk.major:5 .minor:3 -- Added number_window_get_window (API v2.0 revision 12)
// sdk.major:5 .minor:4 -- Added gbitmap_create_blank (API v2.0 revision 13) and click_recognizer_is_repeating (rev 14)
// sdk.major:5 .minor:5 -- Added accel_raw_data_service_subscribe and related types (rev 15)
// sdk.major:5 .minor:6 -- Added background worker APIs (rev 16)
// sdk.major:5 .minor:7 -- Added heap_bytes_free / heap_bytes_used (rev 17)
// sdk.major:5 .minor:8 -- Added compass APIs (rev 18)
// sdk.major:5 .minor:9 -- Added Uuid utility APIs (rev 19)
// sdk.major:5 .minor:a -- Fixed gpath behaviour, added gpath_draw_filled_legacy. (rev 20)
// sdk.major:5 .minor:b -- Added custom animation curves (rev 21)
// sdk.major:5 .minor:c -- Added API for model, color and firmware version of watch (rev 22)
// sdk.major:5 .minor:d -- Added direct access to frame buffer (rev 23)
#define PROCESS_INFO_CURRENT_SDK_VERSION_MAJOR 0x5
#define PROCESS_INFO_CURRENT_SDK_VERSION_MINOR 0xd
